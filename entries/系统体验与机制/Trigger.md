...
创伤治疗文献通常将触发视为与记忆网络相连的条件性线索，当下刺激通过联想激活旧有防御反应。[^briere-scott-2015][^ehlers-clark-2000] 结合社群经验，可将高频触发粗略区分为点式与链式两种系统呈现方式，以便制定更贴合的调节策略。

#### 创伤点式触发

- **系统影响**：激活集中在某一事件或感受的“单节点协议”，能量消耗局部且相对可控。
- **认知体验**：当事人通常能识别“我因 XX 事件而难过”，自我感与现实感仍大体完整。
- **恢复方式**：借助接地、情绪调节或对该事件进行认知重构即可缓冲反应，多数情况下可以快速恢复稳定。[^briere-scott-2015]

#### 创伤链式触发

- **系统影响**：类似“协议链”的级联反应，关联性记忆被连续激活，造成系统性、灾难性的能量耗竭。
- **认知体验**：常伴随自我感被淹没与根本性否定，例如“我从来都只是个旁观者”“我永远帮不上忙”，并可能出现时间感扭曲或解离性穿越。[^van-der-hart-2006]
- **恢复方式**：需要更高强度的现实定向、接地或外部支持；若缺乏干预，恢复期显著拉长。

##### 链式协议回溯示例

当下触发 → 链式启动 → 回溯至某一次“旁观者创伤”经历（例如 9 岁时被指责什么都不做）→ 沿时间线寻找所有带有“旁观者”能量签名的记忆节点 → 最终抵达定义性的源头协议（如小学时期第一次被贴上“只能旁观”的评价）→ 多个节点的情绪与信念汇聚，形成“我一直都是这样”的自我验证回路。

链式模型也可能与其他负性记忆网络相互牵引，形成复合触发，解释了为何某些触发威力巨大——当事人并非只在对抗一次失败，而是在面对整个历史所构建的否定性自我架构。[^brewin-holmes-2003]
