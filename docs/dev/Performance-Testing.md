...
1. **清除缓存**: 确保测试一致性
2. **相同网络条件**: 使用相同的网络模拟（如 Fast 3G）
3. **相同设备**: 使用相同的设备类型（桌面/移动）
4. **多次测试**: 至少测试 3 次取平均值
...
3. 点击 **Record**
4. 刷新页面
5. **等待 DOMContentLoaded 完成后**，立即点击页面上的链接
6. 停止录制
7. 查看 **Interactions** 部分的延迟时间
