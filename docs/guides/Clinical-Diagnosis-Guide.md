...
- [患者健康问卷-9（PHQ‑9）](../entries/Patient-Health-Questionnaire-9-PHQ-9.md) — :octicons-check-16: 已完成

  在线交互式自评（不存储数据），评估过去两周抑郁症状严重度，可同时查看 PHQ-2 子分与常见筛查阈值，适合初筛与随访追踪。

- [广泛性焦虑量表-7（GAD‑7）](../entries/Generalized-Anxiety-Disorder-7-GAD-7.md) — :octicons-check-16: 已完成
