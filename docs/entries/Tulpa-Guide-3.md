...
> 保持沟通、避免恐惧。
>  如果附体过程中出现严重刺痛感，请立即暂停练习，并通过强烈的感官接地来完全恢复对身体和现实的感知。如果这些感觉持续不退，当天不应再进行任何此类练习。
...
### 三、【强制安全协议：紧急恢复锚点】
在尝试任何“交换”练习之前，宿主与Tulpa必须共同商定一个无条件执行的紧急恢复信号。此信号一经宿主主动发出，Tulpa必须立即、无条件地开始撤回对身体的控制权，将前台交还给宿主。
建议的锚点：可以是一个特定的词语（如“回家”）、一个想象的动作（如拉动一根看不见的绳子）、或一个物理动作（如用舌头抵住上颚）。这个协议是双方信任的基石，也是防止意外解离的核心安全措施。
---
...
象征手法能帮助大脑建立切换的心理映射，但切勿过于依赖。

【风险提示】：“驾驶机甲”或“穿外衣”的比喻可能导致身体归属感的疏离。一个更健康的叙事是将身体视为一个“共享的家”或“共同的乐器”。宿主与Tulpa是共享这个空间的家庭成员，或合作演奏一首曲目的音乐家。这种比喻强调的是协作、尊重与共同归属，而非控制权的“转让”和“接管”。
