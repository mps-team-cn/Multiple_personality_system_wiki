...
详细了解请参阅:[解离(Dissociation)](entries/Dissociation.md)、[防御性解离](entries/Defensive-Dissociation.md)、[病理性解离](entries/Pathological-Dissociation.md)
...
**[多意识体(Plurality)](entries/Plurality.md)** 指一个个体内部存在两个或以上相对独立、可持续运作的意识单元。这些意识单元(成员)能够在不同程度上共享记忆、情绪与身体控制权。
...
详细了解请参阅:[多意识体(Plurality)](entries/Plurality.md)、[系统(System)](entries/System.md)
...
**[图帕(Tulpa)](entries/Tulpa.md)** 属于轻微、温和的意识分离:
...
**[解离性身份障碍(DID)](entries/DID.md)** 和 **[其他特定解离性障碍(OSDD)](entries/OSDD.md)** 属于强烈且病理性的意识分离:
...
**[埃蒙加德分类法(Emmengard Classification)](entries/Emmengard-Classification.md)** 是社群内常用的分类框架,按意识体的**来源**进行分类:
...
- [多意识体(Plurality)](entries/Plurality.md) - 总体概念
...
- [PTSD](entries/PTSD.md) / [CPTSD](entries/CPTSD.md) - 创伤后应激障碍
...
- [冥想(Meditation)](entries/Meditation.md) - 意识训练
