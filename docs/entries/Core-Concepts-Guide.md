...
**多意识体系统([MPS](Multiple_Personality_System.md))** 指一个个体内部存在两个或以上相对独立、可持续运作的意识单元。这些意识单元(成员)能够在不同程度上共享记忆、情绪与身体控制权。
...
1. OSDD 可以理解为 DID 的"轻症版本",失忆较轻,主人格地位更明显
1. 在国内,这些诊断统称为"多重人格障碍"或"分离性障碍"
...
1. **关注感受,而非术语** :告诉别人你的主观感受(失忆、失控等)比说专业术语更有效
1. **优先处理创伤** :如果有创伤问题,治疗创伤比研究理论更重要
1. **保持开放** :你的理解可能随时间改变,这很正常

### ⚠️ 避免做的

1. **不要执着于开病历** :确诊很困难,且不一定能带来更好的治疗
1. **不要钻牛角尖** :这些定义和分类本身就不严谨,搞不懂就搞不懂
1. **不要忽视 OSDD** :很多人符合 OSDD 而非 DID,但 OSDD 的普及度很低
1. **不要指望咨询师承认多意识体** :即使专业人士也可能对此了解很少
