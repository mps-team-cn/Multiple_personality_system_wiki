...
- **解离体验** ：常合并[去人格化（Depersonalization）](Depersonalization.md)、[现实解体（Derealization）](Derealization.md)、躯体麻木、漂浮感或恍惚状态。
...
2. **创伤加工** ：在充足安全感下，通过 [EMDR（Eye Movement Desensitization and Reprocessing）](Eye-Movement-Desensitization-Reprocessing-EMDR.md)、结构性解离治疗、[创伤焦点认知行为疗法（Trauma-Focused CBT，TF-CBT）](Trauma-Focused-Cognitive-Behavioral-Therapy-TF-CBT.md)等方法逐步处理创伤记忆。
