...
|---------|------------|--------------|---------------|------|
| [**解离性身份障碍（DID）**](DID.md) [**其他特定解离性障碍（OSDD-1b）**](OSDD.md)| 6B64 | 300.14 | F44.81 | 多个 ANP 与 EP 构成复杂系统（三级结构性解离） |
| [**部分解离性身份障碍（PDID）**](Partial-Dissociative-Identity-Disorder-PDID.md) | 6B65 | — | — | 非主导身份侵入但少有完全切换（仅 ICD-11） |
| [**其他特定解离性障碍（OSDD-1a）**](OSDD.md) | 6B6Y | 300.15 | F44.89 | 接近 DID 但不符合完整标准（二级结构性解离常见） |
