...
1. **发展适应性**：根据儿童年龄和发展水平调整技术
1. **渐进式暴露**：温和、分阶段的创伤加工
1. **技能优先**：先教会应对技能，再处理创伤记忆
...
1. **识别系统成员**：了解谁持有创伤记忆
1. **逐个成员叙事**：允许不同成员讲述自己的创伤故事
1. **内部合作**：鼓励成员互相支持而非冲突
1. **调整节奏**：给予更多时间建立内部安全
1. **照护者教育**：帮助照护者理解多意识体现象
...
1. Cohen, J. A., Deblinger, E., Mannarino, A. P., & Steer, R. A. (2004). A multisite, randomized controlled trial for children with sexual abuse-related PTSD symptoms. *Journal of the American Academy of Child & Adolescent Psychiatry*, 43(4), 393-402.
...
1. National Child Traumatic Stress Network. TF-CBT Web. [https://tfcbt.org](https://tfcbt.org)
