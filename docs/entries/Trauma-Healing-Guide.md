...
| [接受与承诺疗法（ACT）](Acceptance-Commitment-Therapy-ACT.md) | 过度控制情绪、回避痛苦体验、价值观迷失 | 培养心理弹性，接纳困难情绪，基于价值观采取行动 |
...
- **认知行为**：CBT 提供基础的认知重建框架；ACT 强调接纳痛苦体验、培养心理弹性与价值导向行动；CPT、TF-CBT、PE 分别聚焦信念重建、家庭合作与暴露练习，适用于已建立支持网络、愿意逐步面对创伤的成员。
