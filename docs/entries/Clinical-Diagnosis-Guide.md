...
掌握精神医学诊断语言，有助于与医护人员沟通、辨识共病并规划治疗。本导览依据 DSM-5-TR 诊断分类体系整理 `topic: 诊断与临床` 词条，提供从入门概念到鉴别要点的快速路径。
...
- 妄想障碍（Delusional Disorder）：*待更新*
- 短期精神病性障碍（Brief Psychotic Disorder）：*待更新*
- 分裂样障碍（Schizophreniform Disorder）：*待更新*
- [精神分裂症（Schizophrenia）](Schizophrenia-SC.md)：解析阳性症状（幻觉、妄想）、阴性症状与认知障碍。
- 分裂情感性障碍（Schizoaffective Disorder）：*待更新*
- 物质/药物所致精神病性障碍：*待更新*
- 其他医学状况所致精神病性障碍：*待更新*
- 紧张症（Catatonia）：*待更新*
- 其他特定/未特定精神病性障碍：*待更新*
...
- [轻躁狂（Hypomania）](Hypomania.md)：识别较轻程度的躁狂症状及与抑郁的交替模式。
- 物质/药物所致双相及相关障碍：*待更新*
- 其他医学状况所致双相及相关障碍：*待更新*
- 其他特定/未特定双相及相关障碍：*待更新*
...
- 反应性依恋障碍（Reactive Attachment Disorder）：*待更新*
- 去抑制性社交参与障碍（Disinhibited Social Engagement Disorder）：*待更新*
...
- [解离性身份障碍（DID）](DID.md)：介绍核心诊断标准、身份状态分化与鉴别重点。
- [解离性遗忘（Dissociative Amnesia）](Dissociative-Amnesia-DA.md)：聚焦记忆空白、漫游症（dissociative fugue）与临床评估流程。
- [人格解体/现实解体障碍（DPDR）](Depersonalization-Derealization-Disorder-DPDR.md)：辨识持续脱离感与焦虑、抑郁的共病情形。
- [其他特定解离性障碍（OSDD）](OSDD.md)：说明 OSDD-1（类 DID）、OSDD-2 至 OSDD-4 等亚型与评估策略。
- [未特定的解离障碍（USDD）](Unspecified-Dissociative-Disorder-USDD.md)：涵盖信息不足或紧急情境下的诊断使用方式。
- [部分解离性身份障碍（PDID）](Partial-Dissociative-Identity-Disorder-PDID.md)：解析 ICD-11 新增诊断及与 OSDD-1 的差异（ICD-11 专属诊断）。

### 9. 躯体症状及相关障碍（Somatic Symptom and Related Disorders）

- [躯体症状障碍（Somatic Symptom Disorder）](Somatic-Symptom-Disorder-SSD.md)：探讨躯体症状与焦虑、创伤之间的关联。
- 疾病焦虑障碍（Illness Anxiety Disorder）：*待更新*
- [转换障碍/功能性神经症状障碍（FND）](Conversion-Disorder-FND.md)：理解神经系统症状与心理因素的复杂关系。
- 影响其他医学状况的心理因素（Psychological Factors Affecting Other Medical Conditions）：*待更新*
- 人为障碍（Factitious Disorder）：*待更新*
- 其他特定/未特定躯体症状及相关障碍：*待更新*
...
- 延迟射精（Delayed Ejaculation）：*待更新*
- 勃起障碍（Erectile Disorder）：*待更新*
- 女性性高潮障碍（Female Orgasmic Disorder）：*待更新*
- 女性性兴趣/唤起障碍（Female Sexual Interest/Arousal Disorder）：*待更新*
- 生殖器-盆腔疼痛/插入障碍（Genito-Pelvic Pain/Penetration Disorder）：*待更新*
- 男性性腺功能减退障碍（Male Hypoactive Sexual Desire Disorder）：*待更新*
- 早泄（Premature / Early Ejaculation）：*待更新*
- 物质/药物所致性功能障碍：*待更新*
- 其他医学状况所致性功能障碍：*待更新*
- 其他特定/未特定性功能障碍：*待更新*
...
- 对立违抗障碍（Oppositional Defiant Disorder）：*待更新*
- 间歇性暴发障碍（Intermittent Explosive Disorder）：*待更新*
- 品行障碍（Conduct Disorder）：*待更新*
- 反社会人格障碍（Antisocial Personality Disorder）：*待更新*
- 纵火癖（Pyromania）：*待更新*
- 偷窃癖（Kleptomania）：*待更新*
- 其他特定/未特定破坏性、冲动控制及品行障碍：*待更新*

### 16. 物质相关及成瘾障碍（Substance-Related and Addictive Disorders）

- [物质使用障碍（SUD）](Substance-Use-Disorders-SUD.md)：识别成瘾行为、理解创伤与物质使用的关联、实施减害策略与药物辅助治疗（MAT）。
- 酒精相关障碍（Alcohol-Related Disorders）：见 [物质使用障碍](Substance-Use-Disorders-SUD.md)
- 咖啡因相关障碍（Caffeine-Related Disorders）：*待更新*
- 大麻相关障碍（Cannabis-Related Disorders）：*待更新*
- 致幻剂相关障碍（Hallucinogen-Related Disorders）：*待更新*
- 吸入剂相关障碍（Inhalant-Related Disorders）：*待更新*
- 阿片类相关障碍（Opioid-Related Disorders）：见 [物质使用障碍](Substance-Use-Disorders-SUD.md)
- 镇静、催眠或抗焦虑药相关障碍（Sedative-, Hypnotic-, or Anxiolytic-Related Disorders）：*待更新*
- 兴奋剂相关障碍（Stimulant-Related Disorders）：*待更新*
...
- 窥阴障碍（Voyeuristic Disorder）：*待更新*
- 暴露障碍（Exhibitionistic Disorder）：*待更新*
- 摩擦障碍（Frotteuristic Disorder）：*待更新*
- 性受虐障碍（Sexual Masochism Disorder）：*待更新*
- 性施虐障碍（Sexual Sadism Disorder）：*待更新*
- 恋童障碍（Pedophilic Disorder）：*待更新*
- 恋物障碍（Fetishistic Disorder）：*待更新*
- 异装障碍（Transvestic Disorder）：*待更新*
- 其他特定/未特定性欲倒错障碍：*待更新*
...
### 21. 药物诱发运动障碍和其他药物不良反应（Medication-Induced Movement Disorders and Other Adverse Effects of Medication）
...
本节收录非正式诊断名称与已废弃的历史术语，帮助理解旧版病历、媒体报导或历史文献中的用词，并提供现代诊断对照。

### 非正式术语

这些术语虽未出现在 DSM-5-TR 或 ICD-11 中，但在媒体和大众语境中广泛使用。理解其误用方式有助于澄清概念、减少污名。

- [**人格分裂（Split Personality）**](Split-Personality.md)：非正式俗称，常被误用于指代 DID 或精神分裂症。词条澄清两者的本质差异，提供与医护和公众沟通时的教育建议。

### 历史诊断（已过时）

这些诊断曾出现在 DSM-I 至 DSM-IV 或早期医学文献中，现已被更精确的术语取代。了解其演变有助于解读旧版病历或学术研究。

- [**多人格障碍（Multiple Personality Disorder, MPD）**](Multiple-Personality-Disorder-Obsolete.md)：DSM-III（1980）至 DSM-IV（1994）使用的诊断名称，现已改为解离性身份障碍（DID）。
...
!!! tip "使用建议"
    ...
    - **文献研究**：留意发表年代，区分 DSM 版本（I/II/III/III-R/IV/5/5-TR）
    - **教育澄清**：向使用非正式术语的人解释现代诊断名称与差异
    - **减少污名**：主动使用精确术语（如 DID 而非"多重人格"），避免强化刻板印象
