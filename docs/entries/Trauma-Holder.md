...
创伤持有者（Trauma Holder 或 Trauma Bearer）是多意识体系统中专门保留创伤记忆、情绪与身体感受的成员类型,其特征包括：

- **创伤记忆承载**：持有特定创伤事件的详细记忆,包括视觉、听觉、触觉、情绪等多感官信息。
- **情绪体验强度**：对创伤相关情绪（恐惧、羞耻、愤怒、绝望）有深刻且持续的体验。
- **触发敏感性**：容易被与创伤相关的线索（人物、地点、声音、气味、日期）激活并前台。
- **时间感扭曲**：可能体验"创伤时间停滞",感觉创伤仍在发生,难以区分过去与现在。
- **保护性隔离**：通过自身承担创伤,使系统其他成员得以维持日常功能与情绪稳定。
...
- 记忆持有者保管客观记忆内容,创伤持有者承载情感体验。
- 两者的协作可促进创伤记忆的认知-情感整合。参见[记忆持有者（Memory Holder）](Memory-Holder.md)。
...
[^fisher2017]: Fisher, J. (2017). *Healing the Fragmented Selves of Trauma Survivors: Overcoming Internal Self-Alienation*. Routledge.
