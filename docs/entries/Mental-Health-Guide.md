...
**[创伤(Trauma)](entries/Trauma.md)** 是指个体在遭遇或目睹严重威胁生命、身体完整性或核心价值的事件时,所产生的强烈痛苦心理与生理反应。
...
详细了解请参阅:[创伤(Trauma)](entries/Trauma.md)
...
**[创伤后应激障碍(PTSD)](entries/PTSD.md)** 是暴露于死亡威胁、严重伤害或性暴力等创伤事件后,持续出现侵入性体验、回避、认知情绪改变和警觉性改变等症状。
...
详细了解请参阅:[PTSD](entries/PTSD.md)

### 🔴🔴 CPTSD:复杂性创伤后应激障碍

**[复杂性创伤后应激障碍(CPTSD)](entries/CPTSD.md)** 是 ICD-11 新增的诊断,用于描述长期或反复暴露在**无法逃离**的人为创伤后形成的症候群。
...
详细了解请参阅:[CPTSD](entries/CPTSD.md)
...
**解离**是创伤反应的核心机制之一。回顾[核心概念导览](entries/Core-Concepts-Guide.md)中的比喻:
...
详细了解请参阅:[解离(Dissociation)](entries/Dissociation.md)、[病理性解离](entries/Pathological-Dissociation.md)
...
**[抑郁障碍(Depressive Disorders)](entries/Depressive-Disorders.md)** 以持续或反复的抑郁心境、兴趣丧失及多系统功能受损为特征。
...
详细了解请参阅:[抑郁障碍](entries/Depressive-Disorders.md)

### 🟡 焦虑障碍

**[焦虑(Anxiety)](entries/Anxiety.md)** 是对未来威胁的预期所产生的身心状态,可表现为担忧、紧张、警觉性升高以及躯体不适。
...
详细了解请参阅:[焦虑(Anxiety)](entries/Anxiety.md)
...
**[地面化/接地(Grounding)](entries/Grounding.md)** 是一类聚焦当下感官与身体体验的自助策略,用于在焦虑、惊恐、创伤闪回或解离加剧时,迅速恢复对现实情境的觉察与掌控感。
...
详细了解请参阅:[接地(Grounding)](entries/Grounding.md)
...
- [PTSD](entries/PTSD.md)
- [CPTSD](entries/CPTSD.md)
- [触发(Trigger)](entries/Trigger.md)
- [闪回(Flashback)](entries/Flashback.md)

**解离相关**:
- [解离(Dissociation)](entries/Dissociation.md)
- [病理性解离](entries/Pathological-Dissociation.md)
- [防御性解离](entries/Defensive-Dissociation.md)
...
- [心境障碍](entries/Affective-Disorders.md)
