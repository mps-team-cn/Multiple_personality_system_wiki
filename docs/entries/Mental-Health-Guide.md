...
- **辩证行为疗法(DBT)** - 情绪调节、人际效能、痛苦耐受
- **躯体经验疗法(SE)** - 通过身体觉察释放创伤能量
...
[**地面化（Grounding）**](Grounding.md) 用于在焦虑、闪回或解离加剧时,快速回到当下。
...
- **温度刺激** - 冷水洗手/脸,握冰块,喝冰水或热茶
- **身体觉察** - 缓慢走路感受脚与地面接触,紧握拳头再放松
- **结构化任务** - 整理桌面,列待办事项,给物品分类
...
- **共享日志** - 记录前台成员、情绪、触发事件
- **内部沟通协议** - 设定"会议"时间,使用内部白板或笔记
- **分担负荷** - 避免单一成员长期承担创伤或负面情绪,允许轮换休息
- **尊重边界** - 允许成员拒绝某些任务,不强迫融合或消失
...
- [接地（Grounding）](Grounding.md) - 地面化技巧详解
