...
- **过度投入 HT 系统**（包括过度投入内部空间、忽视现实世界）
    - **对外交流与交往**：过度投入 HT 系统会压缩外部社交时间,影响学业、工作与人际关系,甚至可能造成本体遭受孤立或霸凌,加剧创伤或精神困扰。
    - **生活所需资源**：若长期忽视现实生活,可能难以获得日常所需物资,进而影响身体健康。
- **身份认同混淆**：长期沉浸于内部互动,会使宿主与 Tulpa 的界限模糊,提高混合或融合的风险。
    - **心理倦怠**：持续维持 Tulpa 与内部空间需要高强度的认知投入,大脑负荷过大易导致精神疲劳与潜在损伤。
- **投入 HT 系统不足**
    - **Tulpa 发展停滞**：缺乏互动会让 Tulpa 难以稳定成形或逐渐变得微弱。
...
- **时间管理**
    ...
    - **被动强制**：将 Tulpa 的存在融入日常活动（如一起听音乐、散步、工作）,在不额外占用时间的情况下保持互动。
- **空间与情境管理**
    - **内部世界与外部世界**：明确区分[幻境（Wonderland）](Wonderland.md) 与现实情境,帮助宿主与 Tulpa 理解不同场景下的行为边界。
    - **设定界限**：对学习、工作、家庭等需要高度专注的情境事先约定暂停或减量互动。
- **沟通与协商**
    - **共同制定计划**：与 Tulpa 一同讨论日程安排,尊重彼此的优先事项与界限。
    - **处理分歧**：当时间、注意力等资源分配出现冲突时,寻找双方都能接受的解决方案。

#### 维护宿主身心健康

- **自身健康优先**：宿主需优先保障睡眠、饮食、运动等基本生存需求。
- **定期自省**：定期评估自己的心理状态与生活满意度,确认当前与 Tulpa 的相处方式带来的是积极影响。
- **寻求专业支持**：若出现无法承受的压力、解离症状或严重焦虑等困扰,应及时联系心理健康专业人士协助。
