...
ICD-11 将 ADHD 编码为 6A05，要求注意力不集中和/或多动-冲动症状在多个情境中持续至少 6 个月，症状明显超出同龄发展水平，并导致功能受损。ICD-11 区分以下表现类型：
...
DSM-5-TR 要求在 12 岁前出现至少 6 项注意力不集中症状和/或 6 项多动-冲动症状（17 岁及以上为 5 项），症状在两个或以上情境中持续至少 6 个月，明显影响社会、学业或职业功能，且不能用其他精神障碍解释。[^apa2022]

- 主要注意力不集中型（314.00，F90.0）
- 主要多动-冲动型（314.01，F90.1）
- 混合型（314.01，F90.2）

- A. 存在一种持续的注意力不集中和/或多动-冲动模式，干扰功能或发育，具体体现为（1）与/或（2）：在过去 6 个月内，症状在发展水平不相称的程度达到频繁出现。
    - （1）注意力不集中：儿童青少年需 ≥6 项；17 岁及以上需 ≥5 项。

        1. 经常因疏忽而出错或忽略细节；
        2. 难以在任务或游戏中持续专注；
        3. 直接交谈时常显得没在听；
        4. 经常难以按指示完成任务，事情做到一半中断；
        5. 组织能力差（时间管理、排序、材料整理困难）；
        6. 回避或不愿从事需要持续脑力投入的任务（如作业、文书）；
        7. 经常丢失必要物品（钥匙、眼镜、资料、文具等）；
        8. 易被无关刺激或念头分散；
        9. 日常活动容易遗忘（约定、账单、回信等）。

    - （2）多动-冲动：儿童青少年需 ≥6 项；17 岁及以上需 ≥5 项。

        1. 经常坐立不安、手脚多动或扭动；
        2. 需要保持坐姿时常起身离座；
        3. 在不适当的场合跑动或攀爬（成人多为内在躁动感）；
        4. 难以安静地进行休闲活动；
        5. 常被形容为“像被马达驱动”，停不下来；
        6. 说话过多；
        7. 别人问话未完就脱口而出答案；
        8. 难以等待轮次；
        9. 打断、干扰他人（插话、插队、干扰他人活动）。

- B. 若干症状在 12 岁前已存在。
- C. 若干症状出现在两个或以上情境（如家里、学校/工作、与朋友或亲属一起、其他活动）。
- D. 有明确证据表明症状导致社会、学业或职业功能受损或降低生活质量。
- E. 症状并非仅在精神分裂症或其他精神病性障碍过程中出现，且不能更好地用其他精神障碍解释（如心境障碍、焦虑障碍、分离性障碍、人格障碍、物质中毒或戒断等）。
...
- 表现类型：
    ...
    - 以注意力不集中为主：仅 A1 达标；
    - 以多动-冲动为主：仅 A2 达标。
- 是否部分缓解：既往达标，目前近 6 个月未完全达标，但仍有症状并导致损害。
- 严重程度：轻度（症状少、损害轻）、中度、重度（症状多或损害显著）。

### 差异说明

两大诊断系统的核心标准高度一致，均强调症状的持续性、跨情境表现和功能受损。主要差异在于 DSM-5-TR 明确要求症状在 12 岁前出现，而 ICD-11 未设定严格年龄界限，更关注症状的持续性和影响。
