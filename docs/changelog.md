...
- **新增词条（2）**
    - [依恋创伤](entries/Attachment-Trauma.md)
    - [自我状态](entries/Ego-States.md)
- **边界补充与引用整理**
    - 围绕自我状态主题补充想象性陪伴相关引用，强化概念区分与交叉阅读路径

### 🛠️ 工程与维护

- **新增 Makefile 统一维护入口** — 增加 `make check`、`make build`、`make pdf`、`make status` 等常用命令，统一本地检查与构建流程
- 调整 PDF 默认导出路径，减少发布产物路径不一致问题
- 升级 GitHub Actions 版本，保持 CI 环境稳定

### 📱 站点体验与交互修复

- 修复首页模板链接与 Giscus 回退逻辑
- 优化首页 SEO 文案、阅读前说明与导航表达
- 调整量表导出为桌面端直接下载，并按页面注入分享工具以减少无关资源加载
- 修复在线量表导出图片右侧裁切、PHQ-9 题目 ID 冲突、简式量表移动端表头与布局问题
- 清理 SEO 模板噪音与无效日志信息，提升页面整洁度

### 📝 内容与文档更新

- 更新 MID-60 页面结构与说明位置
- 补充仓库许可说明与 README 中英文支持说明
- 更新贡献者墙静态维护文案与核心贡献者信息
- 同步更新部分词条、Guide 与索引格式

### 📊 影响范围

- 新增词条 2 篇，补充多篇相关页面引用与说明
- 统一维护命令入口，降低本地检查与发布操作成本
- 修复多项首页、量表与导出细节问题，改善桌面端与移动端体验
